---
name: project-review
description: Use this skill whenever the user asks to review this project's changes, check architecture compliance, verify tests/build readiness, or produce the project's structured architecture/test/build checklist.
---
