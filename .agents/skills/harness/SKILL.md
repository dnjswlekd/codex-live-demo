---
name: harness
description: Use this skill whenever the user wants to work with this project's Harness workflow, create or update phase/step plans, split implementation work into executable steps, generate phases/index.json or phases/<task>/stepN.md files, or run the Harness executor.
---
